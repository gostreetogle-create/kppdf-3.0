...
## Командный аудит (по запросу)

1. Запусти агентов по `.opencode/audit/TEAM-WORKFLOW.md` (без новой бизнес-логики).
2. Каждый агент — отчёт в формате `chief-architect.md` (OK / FIX / TODO[P0|P1|P2]).
3. Вызови `@chief-architect` → сводка в `.opencode/audit/reports/YYYY-MM-DD.md`.
4. P0 — исправить в том же цикле; P1/P2 — только чеклисты, если пользователь не просил фичи.
