...
| PLM-142 | EPIC #DOCS |
| PLM-126 | Редактор КП → `/quotations/:id` |
| PLM-141 … PLM-139 | подзадачи 8.1.x |
| PLM-138, PLM-137 | PDF, UI /documents |

```
08 Документы (ID-127)                   ← на доске «План развития»
└─ [EPIC #DOCS] Редакторы и печатные формы (ID-142)
    ├─ 8.1 Редактор документа КП (ID-126)     ← /quotations/:id
    │   ├─ 8.1.1 Шаблоны блоков (ID-141)
    │   ├─ 8.1.2 Таблица товаров (ID-140)
    │   └─ 8.1.3 Скидки и итоги (ID-139)
